...
- Software revision: `efadec3cc1fe157b94ceb669ab16c9e8c705fc05`
...
| s5_denied_vio_weak | denied | 0.050 | 0.611 | 1.000 | 0.305 | high | tactical_safe_hold_active | operator_hold_position_and_investigate | FAIL | True | evaluation_threshold_exceeded | 1 | weak | MISSION_SAFE_HOLD | VIO_PRIMARY | 0.550 | weak_texture_v1 | 8.000 |
| s6_denied_vio_lost | denied | 0.050 | 0.092 | 1.000 | 0.038 | high | tactical_abort_active | operator_abort_and_retask | FAIL | True | evaluation_threshold_exceeded | 1 | lost | MISSION_ABORT | HOLD_LAST_SAFE | 0.073 | lost_tracking_v1 | 8.000 |
| s7_conflict_score_dominates | denied | 0.050 | 0.073 | 1.000 | 0.030 | high | tactical_abort_active | operator_abort_and_retask | FAIL | True | evaluation_threshold_exceeded | 1 | lost | MISSION_ABORT | HOLD_LAST_SAFE | 0.061 | lost_tracking_v1 | 8.000 |
| s8_conflict_state_dominates | denied | 0.050 | 0.825 | 1.000 | 0.390 | high | tactical_safe_hold_active | operator_hold_position_and_investigate | FAIL | True | evaluation_threshold_exceeded | 1 | lost | MISSION_SAFE_HOLD | HOLD_LAST_SAFE | 0.760 | nominal_v1 | 8.000 |
...
| s12_fusion_dead_reckoning | denied | 0.050 | 0.092 | 1.000 | 0.038 | high | tactical_abort_active | operator_abort_and_retask | FAIL | True | evaluation_threshold_exceeded | 1 | lost | MISSION_ABORT | HOLD_LAST_SAFE | 0.073 | lost_tracking_v1 | 8.000 |
...
| s15_safe_hold_timeout_abort | denied | 0.050 | 0.759 | 1.000 | 0.393 | high | tactical_abort_active | operator_abort_and_retask | FAIL | True | evaluation_threshold_exceeded | 2 | weak | MISSION_ABORT | VIO_PRIMARY | 0.695 | weak_texture_v1 | 8.000 |
