...
from evaluation.artifact_schema import validate_ros2_launch_probe_results
from evaluation.ros2_launch_probe_compare import compare_ros2_launch_probe
...
class Ros2LaunchProbeCompareTests(unittest.TestCase):
    ...
    def test_compare_detects_runtime_divergence(self) -> None:
        ...
        runtime_trace_path = launch_dir / "s1_nominal_runtime_trace.json"
        ...
        payload = compare_ros2_launch_probe(
            ...
            launch_run_dir=launch_dir,
            scenario_ids=("s1_nominal",),
        )
        self.assertEqual(payload["overall_result"], "FAIL")
        self.assertEqual(payload["scenarios"][0]["probe_result"], "FAIL")
